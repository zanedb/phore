...
struct PhotoLibraryView: View {
    ...
    /// Flag that will show the error prompt if the user does not
        ...
        ZStack {
            ...
            libraryView
                ...
                .alert(
                    ...
                    Text("We need photo library access to show your photos."),
            ...
            if showDetailView {
                detailView
                    // MARK: temporary fix for flash of lower view
                    // THIS IS BUGGY! cannot stay
                    // TODO: FIX THIS
                    .background {
                        Color.black
                    }
